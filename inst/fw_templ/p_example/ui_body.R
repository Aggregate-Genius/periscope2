...
about_box <- jumbotron(
    ...
    lead  = p("periscope is a scalable and UI-standardized 'shiny' framework including a variety of developer convenience",
...
plot_downloader_box <- box(
    ...
    width       = 12,
    tags$dl(tags$dt("Features"),
            tags$ul(tags$li("Periscope offers this module to download plots that have no internal download ability like ggplot2 & lattice."),
...
busy_indicator_box <- box(
    ...
    collapsible = TRUE,
    width       = 12,
    p("Periscope has two application busy indicators"),
...
alerts_box <- box(
    ...
    blockQuote(tags$pre("S:periscope2::createAlert('alert place',
