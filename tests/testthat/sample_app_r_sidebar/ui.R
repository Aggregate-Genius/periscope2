...
periscope2:::fw_reset_app_options()
...
do.call(plus_fxn, c(list(periscope2:::fw_create_header_plus(),
                         periscope2:::fw_create_sidebar(showsidebar = FALSE, resetbutton = FALSE),
                         uiOutput('body'),
                         periscope2:::fw_create_right_sidebar()),
                    addl_opts))
