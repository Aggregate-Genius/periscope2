...
- New functions params:
  - ui_elements
  - ui_position
  - title: it will override the title param in set_app_parameters
    function in program/global.R
  - title position
- CSS changes This update to be added to already created apps
...
- Now periscope_style can be generated directly from [theme
  configuration addin
  Add-ins](https://aggregate-genius.github.io/periscope2/articles/themeBuilder_addin.md)
...
- Use [theme configuration addin
  Add-ins](https://aggregate-genius.github.io/periscope2/articles/themeBuilder_addin.md)
  to generate a periscope_style.yaml file with the above keys

## periscope Alert

In generated applications change: -
[`periscope2::createAlert`](https://bs4dash.rinterface.com/reference/alert.html)
to only `createPSAlert` with the same parameters
